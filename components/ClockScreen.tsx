...
const ClockScreen: React.FC<ClockScreenProps> = ({ employee, onLogout, events, onAddEvent }) => {
    ...
    return (
        <div className="glass-panel w-full max-w-md mx-auto animate-fade-in flex flex-col space-y-6 relative">
            {processingType && (
                <div className="fixed inset-0 flex flex-col items-center justify-center z-50 animate-fade-in" style={{backgroundColor: 'rgba(0, 0, 0, 0.8)', backdropFilter: 'blur(5px)'}}>
                    <svg className="animate-spin text-gold mb-4" style={{width: '64px', height: '64px'}} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                        <circle className="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4"></circle>
                        <path className="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
                    </svg>
                    <h3 className="text-2xl font-bold text-white">Aguarde...</h3>
                    <p className="text-gray-300 mt-2 text-lg">Registrando o seu ponto</p>
                </div>
            )}
